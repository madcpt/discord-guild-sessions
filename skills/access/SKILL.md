---
name: access
description: Manage Discord guild session access — approve pairings, edit allowlists, set DM/group policy. Use when the user asks to pair, approve someone, check who's allowed, or change policy for the Discord guild session channel.
user-invocable: true
allowed-tools:
  - Read
  - Write
