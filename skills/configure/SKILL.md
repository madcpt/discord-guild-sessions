---
name: configure
description: Set up the Discord guild session channel — save the bot token, set guild ID, and review access policy. Use when the user pastes a Discord bot token, asks to configure Discord guild sessions, or wants to check channel status.
user-invocable: true
allowed-tools:
  - Read
  - Write
